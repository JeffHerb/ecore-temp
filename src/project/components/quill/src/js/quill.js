...
function _sanitize(url, protocols) {
  ...
  // Added this line of code to enforce target blank - JH 9/16/2018
...
var SizeClass = new _parchment2.default.Attributor.Style('size', 'font-size', {
  scope: _parchment2.default.Scope.INLINE,
  //whitelist: ['small', 'medium', 'large', 'huge']
  //whitelist: ['10px', '11px', '13px', '15px']
  whitelist: ['8px', '9px', '10px', '11px', '12px', '14px', '16px', '18px', '20px', '22px', '24px', '26px', '28px', '30px', '32px', '48px', '72px']
});
// var SizeClass = new _parchment2.default.Attributor.Class('size', 'font-size', {
//   scope: _parchment2.default.Scope.INLINE,
//   whitelist: ['10px', '11px', '13px', '15px']
// });
...
var SIZES = ['8px', '9px', '10px', '11px', '12px', '14px', '16px', '18px', '20px', '22px', '24px', '26px', '28px', '30px', '32px', '48px', '72px'];

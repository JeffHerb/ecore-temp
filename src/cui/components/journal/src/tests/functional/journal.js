define(function (require) {
    ...
    registerSuite({
        ...
        // 'Journal 1 Button Exists': function () {
        //     return this.remote
        //         .get(require.toUrl('http://localhost:8888/tests/journal/pages/journal.html'))
        //         .setFindTimeout(5000)
        //         .execute(function(){
        ...
        // //Can't seem to get the pressKeys method to work properly to trigger an escape press.

        // // 'Close Modal 1 by pressing "ESC"': function () {
        // //     return this.remote
        // //         .setFindTimeout(5000)
        // //         .findById('E_MODAL_BUTTON_1')
        // //             .click()
